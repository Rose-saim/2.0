...
import { ArrowLeft, Building2, Target, ChartBar, Quote } from 'lucide-react';
...
export default function CaseStudyDetail() {
  ...
  const caseStudy = {
    ...
    testimonial: {
      quote: "The AI implementation has transformed how we deliver services to our citizens. The results have exceeded our expectations.",
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <ChartBar className="w-6 h-6 text-blue-600 mb-2" />
            ...
            <div className="bg-blue-50 rounded-xl p-8 mb-12">
              ...
              <div className="text-sm">
                ...
                <p className="text-gray-600">
                  {caseStudy.testimonial.role}, {caseStudy.testimonial.organization}
                </p>
              </div>
            </div>
